...
pyramid_points = [
    (0, -scale, 0),  # Top point of the pyramid
    (scale, scale, scale),  # Bottom-left-front
    (-scale, scale, scale),  # Bottom-right-front
    (-scale, scale, -scale),  # Bottom-right-back
    (scale, scale, -scale)  # Bottom-left-back
]
...
def main():
    ...
    while True:
        list = cube_points(pyramid_points, angle)
        # Define edges of the pyramid
        face_front = [list[0], list[1], list[2], list[0]]  # Top to front base
        fave_back = [list[0], list[3], list[4], list[0]]  # Top to back base
        edge1 = [list[1], list[4]]  # Left base edge
        edge2 = [list[2], list[3]]  # Right base edge
        edge3 = [list[1], list[2]]  # Front base edge
        edge4 = [list[3], list[4]]  # Back base edge
